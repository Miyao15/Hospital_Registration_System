...
INSERT INTO `appointments` VALUES ('37fe4ec2-78b0-48ad-8086-9a635fea39f7', 'GH20251229543016', 'a3c6dd79-4f0e-4ca0-927e-50dc62bc6111', 'doc-003', 'dpt-003', 'ts-006', '2025-12-30', 'AFTERNOON', '李想', '13344445555', '', 'EXPIRED', NULL, '2025-12-29 18:11:31', '2025-12-31 01:00:00', NULL);
...
INSERT INTO `appointments` VALUES ('88ee3547-03b3-498a-8594-ebb527445991', 'GH20251229286975', 'a3c6dd79-4f0e-4ca0-927e-50dc62bc6111', 'doc-001', 'dpt-001', 'ts-001', '2025-12-30', 'MORNING', '李想', '13344445555', '', 'EXPIRED', NULL, '2025-12-29 18:31:19', '2025-12-31 01:00:00', NULL);
...
INSERT INTO `appointments` VALUES ('apt-001', 'APT20251229001', 'pat-001', 'doc-001', 'dpt-001', 'ts-001', '2025-12-30', 'MORNING', '赵小明', '13800000004', '最近一周感到胸闷，偶尔心悸。', 'EXPIRED', NULL, '2025-12-29 14:20:57', '2025-12-31 01:00:00', NULL);
...
INSERT INTO `appointments` VALUES ('apt-004', 'APT20251229004', 'pat-003', 'doc-003', 'dpt-003', 'ts-006', '2025-12-30', 'AFTERNOON', '周先生', '13700000001', '脸上出现红疹，很痒。', 'EXPIRED', NULL, '2025-12-29 14:20:57', '2025-12-31 01:00:00', NULL);
...
CREATE TABLE `doctors`  (
  ...
  `hospital_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '医院ID',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `user_id`(`user_id` ASC) USING BTREE,
  UNIQUE INDEX `employee_id`(`employee_id` ASC) USING BTREE,
...
-- Records of doctors
-- ----------------------------
INSERT INTO `doctors` VALUES ('67d5fa84-268b-4125-8000-306d35c34245', '138fe1f1-228b-4f0b-a4ea-aef1d6108da7', '孟新', '55555555', 'ATTENDING', 'dpt-004', 'General', '11122223333', 'N/A', NULL, NULL, NULL, '2025-12-29 19:50:50', '2025-12-31 00:38:55', NULL, NULL, 'hosp-001');
INSERT INTO `doctors` VALUES ('bf18a1fa-1e8d-4dcb-a30c-a1003228412a', '539a90b4-c1a0-4ab4-aadc-35f1ead13c46', '孟听', '333333', 'RESIDENT', 'dpt-004', 'General', '', 'N/A', NULL, NULL, NULL, '2025-12-29 20:04:24', '2025-12-31 00:38:55', '', NULL, 'hosp-001');
INSERT INTO `doctors` VALUES ('doc-001', 'usr-doc-001', '李医生', 'D0001', 'CHIEF', 'dpt-001', '高血压、冠心病的诊断与治疗', 'LIC20230001', '李医生是心血管内科主任医师，拥有超过20年的临床经验。', NULL, '2025-12-29 14:20:57', 'adm-001', '2025-12-29 14:20:57', '2025-12-31 00:38:55', NULL, NULL, 'hosp-001');
INSERT INTO `doctors` VALUES ('doc-002', 'usr-doc-002', '张医生', 'D0002', 'ATTENDING', 'dpt-002', '骨折、关节置换', 'LIC20230002', '张医生是骨科主治医师，擅长运动损伤和微创手术。', NULL, '2025-12-29 14:20:57', 'adm-001', '2025-12-29 14:20:57', '2025-12-31 00:38:55', NULL, NULL, 'hosp-001');
INSERT INTO `doctors` VALUES ('doc-003', 'usr-doc-003', '王医生', 'D0003', 'RESIDENT', 'dpt-003', '痤疮、湿疹、皮肤过敏', 'LIC20230003', '王医生是皮肤科的住院医师，对常见皮肤病有深入研究。', NULL, '2025-12-29 14:20:57', 'adm-001', '2025-12-29 14:20:57', '2025-12-31 00:38:55', NULL, NULL, 'hosp-001');
INSERT INTO `doctors` VALUES ('doc-004', 'usr-doc-004', '刘医生', 'D0004', 'ASSOCIATE_CHIEF', 'dpt-004', '新生儿疾病、儿童生长发育评估', 'LIC20230004', '刘医生，儿科副主任医师，经验丰富，深受家长信赖。', NULL, NULL, NULL, '2025-12-29 14:20:57', '2025-12-31 00:38:55', NULL, NULL, 'hosp-001');
INSERT INTO `doctors` VALUES ('doc-005', 'usr-doc-005', '陈医生', 'D0005', 'ATTENDING', 'dpt-005', '白内障、青光眼及近视矫正', 'LIC20230005', '陈医生专攻眼科常见病及手术治疗。', NULL, '2025-12-29 14:20:57', 'adm-001', '2025-12-29 14:20:57', '2025-12-31 00:38:55', NULL, NULL, 'hosp-001');
INSERT INTO `doctors` VALUES ('doc-006', 'usr-doc-006', '口腔科医生', 'D0006', 'ATTENDING', 'dpt-006', '口腔疾病诊治、牙齿修复', 'LIC20230006', '专业口腔科医生，擅长口腔疾病诊治和牙齿修复。', NULL, '2025-12-30 12:59:39', 'adm-001', '2025-12-30 12:59:39', '2025-12-31 00:38:55', NULL, NULL, 'hosp-001');
INSERT INTO `doctors` VALUES ('doc-007', 'usr-doc-007', '妇科医生', 'D0007', 'ATTENDING', 'dpt-007', '妇科疾病诊治、妇科常规检查', 'LIC20230007', '专业妇科医生，擅长妇科疾病诊治和常规检查。', NULL, '2025-12-30 12:59:39', 'adm-001', '2025-12-30 12:59:39', '2025-12-31 00:38:55', NULL, NULL, 'hosp-001');
INSERT INTO `doctors` VALUES ('fac83766-9464-48f4-8b3d-eeda49dd69b0', 'a2250584-bb99-4c64-a542-4e6bf497ff5d', '张名', '00000000', 'ATTENDING', 'dpt-003', 'General', '13344445555', 'N/A', NULL, '2025-12-30 10:30:06', '4bddc762-b2b2-4795-b04b-e06eba14730e', '2025-12-29 17:30:06', '2025-12-31 00:38:55', NULL, NULL, 'hosp-001');
...
CREATE TABLE `hospitals`  (
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '医院ID (UUID)',
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '医院名称',
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '医院地址',
  `phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '联系电话',
  `longitude` double NULL DEFAULT NULL COMMENT '经度',
  `latitude` double NULL DEFAULT NULL COMMENT '纬度',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '医院简介',
  `enabled` tinyint(1) NULL DEFAULT 1 COMMENT '是否启用',
  `created_at` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `name`(`name` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '医院表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of hospitals
-- ----------------------------
INSERT INTO `hospitals` VALUES ('hosp-001', '天津医科大学总医院', '天津市和平区鞍山道154号', '022-60362255', 117.195907, 39.104027, '天津医科大学总医院始建于1946年，是天津市最大的集医疗、教学、科研、预防为一体的综合性大学医院。', 1, '2025-12-31 00:38:55', '2025-12-31 00:38:55');
...
-- Records of patients
-- ----------------------------
INSERT INTO `patients` VALUES ('7f6e6ec2-0704-4c98-b038-004c1cb39c88', 'e6136341-04e4-481b-bafd-87f49ab6121d', '患者', '110101199003074518', 'MALE', '2025-12-31', NULL, NULL, NULL, NULL, '2025-12-31 00:12:08', '2025-12-31 00:12:08');
...
INSERT INTO `users` VALUES ('e6136341-04e4-481b-bafd-87f49ab6121d', '13800138001', '$2a$10$eCbIkscBKSvw8V.bzxRZLuJEud0ed0ZjywfAGAFXaXPaQvXZemkiS', 'PATIENT', 'ACTIVE', 0, NULL, '2025-12-31 00:12:08', '2025-12-31 00:13:24', '2025-12-31 00:13:24');
